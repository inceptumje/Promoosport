 ...
 */
final class Version20220318182441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE league CHANGE updated_at updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE league CHANGE updated_at updated_at DATETIME DEFAULT NULL');
