...
class MatchFootController extends AbstractController
{
     ...
     */
    public function accessFront(Request $request, MatchFootRepository $mfrp, LeagueRepository $lrp , PromosportRepository $promosportRepository): Response
    {
        $matches = $mfrp->findAll();
        $leagues = $lrp->findAll();
     ...
     */
    public function getMatchesByLeague(MatchFootRepository $mfrp, LeagueRepository $lrp, $leagueId , PromosportRepository $promosportRepository): Response
    {
        ...
        $leagues = $lrp->findAll();
        $promo = $promosportRepository->findAll();
